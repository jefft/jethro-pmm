...
// Database connection
// Socket-only (mariadb TCP is disabled in devbox): MYSQL_UNIX_PORT is passed
// through to this pool by devbox.d/php/php-fpm.conf (cf. devbox.d/web/conf.php).
$dsn = 'mysql:unix_socket=' . getenv('MYSQL_UNIX_PORT') . ';dbname=jethro_functest_smsmockserver;charset=utf8mb4';
// The devbox convention: every database is reachable as jethro/jethro
// (see devbox.d/mariadb/my.cnf and devbox.d/bin/mariadb_ensure_db).
$user = 'jethro';
$pass = 'jethro';

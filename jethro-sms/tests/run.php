 ...
 *   php tests/run.php cellcast             # run a subset
 *
 * Test files go in tests/<area>/ and use the Test\ namespace helpers.
 ...
 * docblock; the runner executes it in a child `php tests/run.php
...
// If a vendor autoloader exists, load it.  Otherwise the jethro-sms package

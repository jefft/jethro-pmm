/*
 * Datastar v1.0.2 — VENDORED, DO NOT EDIT.
 *
 * Source: https://github.com/starfederation/datastar (release tag v1.0.2)
 *   downloaded from https://cdn.jsdelivr.net/gh/starfederation/datastar@v1.0.2/bundles/datastar.js
 *
 * Self-initialising ES-module bundle. Loaded via a single
 *   <script type="module" src=".../resources/js/datastar.min.js">
 * tag in templates/head.template.php (no bundler / build step — see
 * docs/docs/developer/reference/sms/SMS_DATASTAR.md).
 *
 * SSE event names used by include/sse.php: datastar-patch-elements,
 * datastar-patch-signals (v1.x naming).
 *
 * To upgrade: download the bundles/datastar.js for the new release tag,
 * replace the body below this header, update the version here, in
 * SMS_DATASTAR.md, and in the AGENTS.md vendored-files table, then
 * re-confirm the SSE event names still match include/sse.php.
 */
// Datastar v1.0.2

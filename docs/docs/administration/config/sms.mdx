...
import { MultiSettings } from '../../../src/components/SettingComponents';
...
export function SenderPresets() {
  ...
  return (
    <div style={{ border: '1px solid #e5e7eb', padding: '1em' }}>
        ...
        <MultiSettings group="sender" key={JSON.stringify(preset.values)} values={preset.values} />
        <h5>Preview</h5>
...
<MultiSettings group="postSendBehaviour" />

### Low Balance
<MultiSettings group="balance" />

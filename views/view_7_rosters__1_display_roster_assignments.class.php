	...
	function _printParams()
	{
			...
			if ($viewid) {
				if (!$this->_editing) {
					...
					echo '<a target="print-roster" class="med-newwin nowrap" href="'.BASE_PATH.'?call=display_roster&viewid='.$viewid.'&start_date='.$this->_start_date.'&end_date='.$this->_end_date.'"><i class="icon-print"></i>Show printable version</a> &nbsp; ';
					...
					if (!SizeDetector::isNarrow()) {
						...
						<div id="merge-modal" class="modal sms-modal hide fade" role="dialog" aria-hidden="true">
							...
							<div class="modal-body">
								...
								<span class="smallprint"><a target="roster-merge-help" class="med-newwin" href="<?php echo BASE_PATH; ?>index.php?call=document_merge_help"><i class="icon-print"></i>Help and examples</a><br></span>
							</div>
